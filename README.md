...
- **Designed, pending approval — nothing implemented yet**: friction-free quick capture (`/kanban/journal`) with background LLM categorization and a day-grouped infinite-scroll feed; design in `design/flows/journal.md`, exploration mockup in `design/mockup/future-work/mockup-journal.html`
