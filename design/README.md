...
| [component-library.md](./component-library.md) | Proposal: the structural `ui/` component layer on top of the FX skin — tiers, conventions, migration phases, and the mockup→scenario retirement plan. |
