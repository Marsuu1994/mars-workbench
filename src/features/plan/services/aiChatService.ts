...
import { draftPlanResponseSchema, type DraftPlanResponse } from "@/lib/kanban/schemas";
import { buildDraftPlanSystemPrompt } from "../prompt/draftPlanPrompt";
import { getTodayDate, getISOWeekKey } from "@/lib/kanban/dateUtils";
import type { ActiveChatPayload, ChatMetadata } from "../types/aiChat";
import type { LastPlanStats, PerTemplateStat } from "@/lib/kanban/types";
import {
  NEW_USER_CHIP_KEYS,
