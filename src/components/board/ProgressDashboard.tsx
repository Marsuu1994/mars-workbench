  ...
  return (
    <>
      ...
      <div className="flex md:hidden flex-col gap-1.5 px-4 py-2 border-b border-base-content/10 bg-base-200/50">
        ...
        <div className="flex items-center gap-2 h-5">
          ...
          <span className="text-[11px] text-base-content/50 shrink-0">
            <strong className="fx-num text-base-content/70 font-bold">{todayDonePoints}</strong> {t("pts")}
          </span>
        </div>
        {/* Week row */}
        <div className="flex items-center gap-2 h-5">
          ...
          <span className="text-[11px] text-base-content/50 shrink-0">
            <strong className="fx-num text-base-content/70 font-bold">{weekDonePoints}</strong> {t("pts")}
          </span>
          <span className="text-[11px] text-base-content/50 shrink-0">
            <strong className="fx-num text-warning font-bold">{dailyAvg}</strong> {t("avg")}
          </span>
        </div>
      </div>
      ...
      <div className="hidden md:flex items-center gap-6 px-4 py-3 border-b border-base-content/10 bg-base-200/50">
        ...
        {/* Daily Avg */}
        <div className="flex flex-col gap-px">
          <div className="fx-num text-lg font-bold text-warning">{dailyAvg}</div>
        ...
        <div className="flex-1 flex flex-col gap-1 min-w-0">
          <div className="flex justify-between items-center">
            <span className="fx-label fx-label-bright">{t("weekProgress")}</span>
            <span className="fx-num text-xs font-semibold text-info">{weekPct}%</span>
          </div>
